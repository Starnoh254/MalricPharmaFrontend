        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-grayText max-w-2xl mx-auto">
              ...
              services with convenience and care at the center of everything we
              do.
            </p>
          </div>
      ...
      <section className="py-16 bg-secondary text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Browse our extensive collection of medications and health products.
            Professional consultation available for all your healthcare needs.
          </p>
